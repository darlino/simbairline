...
return [
    ...
    'finish'       => __('Installer'),
    'forms'        => [
        'errorTitle' => __('Ces erreurs ont survenu:'),
    ],
    /**
     *
     ...
     */
    'welcome'      => [
        'templateTitle' => __('Bienvenue'),
        'title'         => __('Installation'),
        'message'       => __('Installation facile et Panneau de Configuration'),
        'next'          => __('Verification des outils requis'),
    ],
    /**
     *
     ...
     */
    'requirements' => [
        'templateTitle' => __('Etape 1 | Outils requis par le serveur'),
        'title'         => __('Outils requis par le serveur'),
        'next'          => __('Verification des Permissions'),
    ],
    /**
     *
     ...
     */
    'permissions'  => [
        'templateTitle' => __('Etape 2 | Permissions'),
        'title'         => __('Permissions'),
        'next'          => __('Configuration d\'Environnement'),
    ],
    /**
     *
    ...
    'environment'  => [
        'menu'    => [
            'templateTitle'  => __('Etape 3 | Configuration d\'Environnement'),
            'title'          => __('Configuration d\'Environnement'),
            'desc'           => __('Choisissez comment configuer le fichier <code>.env</code> de l\'application.'),
            'wizard-button'  => __('Panneau de configuration'),
            'classic-button' => __('Editeur de texte classique'),
        ],
        'wizard'  => [
            'templateTitle' => __('Etape 3 | Configuration d\'Environnement | Panneau Guidé'),
            'title'         => __('Panneau <code>.env</code> Guidé'),
            'tabs'          => [
                'environment' => __('Environnement'),
                'database'    => __('Base de Données'),
