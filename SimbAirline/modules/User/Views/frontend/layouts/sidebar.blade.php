...
<div class="sidebar-user">
        ...
        <div class="info-new">
            ...
            @if(isset(Auth::user()->parent))
                <span style="cursor: pointer">
                    {{ __('Sponsored by ') }} <b class="text-warning">{{ '@'.Auth::user()->parent }}</b>
                </span>
            @endif
        </div>
    </div>
    ...
    @if( Auth::user()->hasPermissionTo("dashboard_vendor_access") )
        <div class="user-profile-plan">
            <b>{{ __('Sponsored Link') }}</b><br/><br/>
            @if(isset(Auth::user()->user_name))
                <span class="badge badge-warning" style="cursor: pointer" onclick="myFunction()"
                      title="{{ config('app.url') }}register?key={{ Auth::user()->user_name }}">
                    {{ __('Copy Link') }}
                </span>
                <input type="text" value="{{ config('app.url') }}register?key={{ Auth::user()->user_name }}" id="myInput"
            ...
            @else
                <a class="badge badge-danger" style="cursor: pointer" href="{{ route("user.profile.index") }}">
                    Mettre &agrave; Jour
                </a><br/>
                <small>{{__('Add your username to create a sponsor link')}}</small>
            @endif
        </div>
    @endif
