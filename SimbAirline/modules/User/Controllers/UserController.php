...
class UserController extends FrontendController
{
    ...
    public function commissions(Request $request){
        $user_id = Auth::id();
        $rows = Commission::where("user_id", $user_id)->orderBy('created_at');
        $data = [
        ...
        return view('User::frontend.commission', $data);
    }

    public function team(Request $request){
        $user = Auth::user()->user_name;
        $rows = User::where("parent", $user)->orderBy('created_at');
        $data = [
            'rows'        => $rows->paginate(10),
            'breadcrumbs' => [
                [
        ...
        return view('User::frontend.team', $data);
    }
