<form class="form bravo-form-register" method="post">
    ...
    @if (isset($sponsor))
        <div class="form-group">
            <input type="text" class="form-control" name="sponsor" autocomplete="off" placeholder="{{__('Sponsor')}}" value="@ {{ $sponsor->user_name }}" disabled>
            <i class="input-icon field-icon icofont-waiter-alt"></i>
        </div>
        <div class="form-group">
            <input type="hidden" class="form-control" name="parent" value="{{ $sponsor->user_name }}" disabled>
            <i class="input-icon field-icon icofont-waiter-alt"></i>
        </div>
    @endif
    <div class="form-group">
