...
<head>
    ...
    <style type="text/css">
        *, html, body, div, b, i, span, :root{
            font-family: 'Roboto', sans-serif;
        }
    </style>

    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Simb Airline'}}</title>
    ...
    <div class="main-content">
        ...
        <footer class="main-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" style="color:black">
                       &copy; Copyright  {{date('Y')}} <b>Simb-Airlines Corporation</b>. All rights reserved
                    </div>
                </div>
            </div>
        </footer>
