                                            ...
                                            @if(!empty($booking->gateway))
                                                ...
                                                @if($gateway)
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="val"><b class="badge badge-success">{{$booking->transactionID}}</b></div>
                                                        </li>
                                                        <li>
                                                            <div class="label">{{__('Transaction Sender Name')}}</div>
                                                            <div class="val"><b>{{$booking->sender}}</b></div>
                                                        </li>
                                                        <li>
                                                            <div class="label">{{__('Transaction Receiver Name')}}</div>
                                                            <div class="val"><b>{{$booking->receiver}}</b></div>
                                                        </li>
                                                 @endif
                                            @endif
