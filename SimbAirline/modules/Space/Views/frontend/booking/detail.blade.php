...
<div class="booking-review">
    ...
    <div class="booking-review-content">
        ...
        <div class="review-section total-review">
            <ul class="review-list">
                @php
                    $price_item = $booking->total_before_extra_price * $booking->total_guests;
                @endphp
                @if(!empty($price_item))
                    <li>
                    ...
                    <ul class="review-list list-unstyled">
                            <li class="mb-3 pb-1 border-bottom">
                                ...
                                <div class="d-flex justify-content-between font-weight-bold px-2">
                                    <span>{{__("Total:")}}</span>
                                    <span>{{format_money(array_sum(\Illuminate\Support\Arr::pluck($dateDetail,['price'])) * $booking->total_guests)}}</span>
                                </div>
                            </li>
                    </ul>
            </div>
