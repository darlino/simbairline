            ...
            <div class="info-form">
                <ul>
                    ...
                    @if ($booking->object_model === "space")
                        <li class="info-notes">
                            <div class="label">{{__('Data Image')}}</div><br/>
                            <div class="val"><img src="{{ asset($booking->data_img_1) }}" width="150px" height="150px" /></div>
                            <div class="val"><img src="{{ asset($booking->data_img_2) }}" width="150px" height="150px" /></div>
                            <div class="val"><img src="{{ asset($booking->data_img_3) }}" width="150px" height="150px" /></div>
                            <div class="val"><img src="{{ asset($booking->data_img_4) }}" width="150px" height="150px" /></div>
                        </li>
                    @endif
                </ul>
            </div>
