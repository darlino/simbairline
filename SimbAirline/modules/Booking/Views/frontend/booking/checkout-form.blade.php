<div class="form-checkout" id="form-checkout" >
    ...
    <div class="form-section">
        <div class="row">
            ...
            <div class="col-md-12 field-passport">
                <div class="form-group">
                    <label >{{__("Passport Image")}} + {{__("Yellow card")}}<span class="required">*</span></label>
                    <input type="file" multiple class="form-control" accept="image/*" name="passport" id="passport" value="{{ old('passport') }}">
                </div>
                <div id="uploadArea">
                </div>
            </div>
